...
The program features an interactive interface, guiding users to choose days, input task times, and describe activities. It automatically validates user input to prevent errors like invalid days or duplicate task times. After all tasks are added, it provides a clear, organized view of the weekly routine, showing each day’s schedule in a readable format.

Benefits of this program include:

Effective time management: Avoids overlapping tasks and helps prioritize activities.

Organization: Keeps all tasks structured by day and time for easy reference.

Flexibility: Users can plan any number of days (1–7) and add tasks dynamically.
